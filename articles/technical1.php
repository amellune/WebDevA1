...
$stmt = $pdo->prepare("SELECT * FROM `articles` WHERE `articleId` = '3'");
...
while($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
	...
	?>
    <br>
	<a href="https://thenextweb.com/syndication/2020/10/17/you-influence-recommendation-algorithms-just-as-much-as-they-influence-you-heres-how/"> External Source</a>
    <br>
