...
$stmt = $pdo->prepare("SELECT * FROM `articles` WHERE `articleId` = '12'");
...
while($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
    ...
    echo("</h1>");
	echo("<h3>");
	echo($row["author"]."<br><br> Category: ".$row["category"]);
    echo("</h3>");
    echo("<p>");
    echo($row["content"]); //or $row[0];
	?>
    <br>
	<a href="https://www.kollimited.com/understanding-the-covid-19-effects-on-web-development-industry"> External Source</a>
    <br>
