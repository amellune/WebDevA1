...
$stmt = $pdo->prepare("SELECT * FROM `articles` WHERE `articleId` = '4'");
...
while($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
	...
	?>
    <br>
	<a href="https://thenextweb.com/shift/2020/10/15/adaptive-traffic-lights-trial-aims-to-cut-fuel-consumption-by-20-syndication/"> External Source</a>
    <br>
