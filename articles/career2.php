...
$stmt = $pdo->prepare("SELECT * FROM `articles` WHERE `articleId` = '2'");
...
while($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
	...
	?>
    <br>
	<a href="https://thenextweb.com/growth-quarters/2020/09/04/turning-your-imposter-syndrome-from-enemy-to-ally-syndication/"> External Source</a>
    <br>
